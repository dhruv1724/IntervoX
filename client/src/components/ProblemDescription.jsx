...
//mainly ui will be added here using the params passed in the function
function ProblemDescription({problem,currentProblemid, onProblemChange, allProblems}) {
  return (
    <div className='h-full overflow-y-auto bg-base-200'>
      {/* HEADER SECTION */}
      <div className='p-6  bg-base-1000 border-b border-base-300'>
      ...
      <div className='p-6 space-y-6'>
        {/* Problem description */}
        <div className="bg-base-100 rounded-xl shaadow-sm p-5 border border-base-300">
